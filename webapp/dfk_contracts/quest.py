...
QUEST_ADDRESSES = {
    '0x0548214A0760a897aF53656F4b69DbAD688D8f29': 'Wishing well',
...
ABI = [{
  ...
  "inputs": [{
    ...
    "indexed": False,
    "internalType": "struct IQuestTypes.QuestType",
    "name": "questType",
    "type": "tuple"
  }],
  "name": "QuestAdded",
  ...
  "outputs": [{
    ...
    "internalType": "struct IQuestTypes.QuestData",
    "name": "",
    "type": "tuple"
  }],
  "stateMutability": "view",
  ...
  "inputs": [{
    ...
    "components": [{
      ...
      "internalType": "int64",
      "name": "smallSkillUpMod",
      "type": "int64"
    }, {
      "internalType": "int64",
      "name": "mediumSkillUpMod",
      "type": "int64"
    }, {
      "internalType": "int64",
      "name": "largeSkillUpMod",
      "type": "int64"
    }, {
      "internalType": "int64",
      "name": "baseChance",
    ...
    "internalType": "struct IQuestTypes.RewardItem",
    "name": "_reward",
    "type": "tuple"
  }, {
    "internalType": "uint256",
  ...
  "inputs": [{
    "internalType": "uint256",
    "name": "_timePerStamina",
    "type": "uint256"
  }],
  "name": "setTimePerStamina",
  "outputs": [],
  "stateMutability": "nonpayable",
  "type": "function"
}, {
